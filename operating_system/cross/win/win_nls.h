...
#define MAX_DEFAULTCHAR           2           // single or double unsigned char
...
#define MUI_CALLBACK_ALL_FLAGS                        MUI_CALLBACK_FLAG_UPGRADED_INSTALLATION // OR all other flags when defined.
   ...
   typedef struct _cpinfo {
      ...
      BYTE    LeadByte[MAX_LEADBYTES];        // lead unsigned char ranges
   } CPINFO, *LPCPINFO;
...
#define GSS_ALLOW_INHERITED_COMMON  0x0001  // Output script ids for inherited and common character types if present
   ...
   typedef WINBOOL (CALLBACK* LANGUAGEGROUP_ENUMPROCA)(LGRPID, LPSTR, LPSTR, DWORD, int_ptr);
   //xxx linux typedef WINBOOL (CALLBACK* LANGGROUPLOCALE_ENUMPROCA)(LGRPID, LCID, LPSTR, long_ptr);
   typedef WINBOOL (CALLBACK* UILANGUAGE_ENUMPROCA)(LPSTR, int_ptr);
   ...
   typedef WINBOOL (CALLBACK* LANGUAGEGROUP_ENUMPROCW)(LGRPID, LPWSTR, LPWSTR, DWORD, int_ptr);
   //xxx linux typedef WINBOOL (CALLBACK* LANGGROUPLOCALE_ENUMPROCW)(LGRPID, LCID, LPWSTR, long_ptr);
   typedef WINBOOL (CALLBACK* UILANGUAGE_ENUMPROCW)(LPWSTR, int_ptr);
