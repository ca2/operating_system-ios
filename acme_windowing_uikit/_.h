...
#if defined(_acme_windowing_uikit_project)
#define CLASS_DECL_ACME_WINDOWING_UIKIT CLASS_DECL_EXPORT
#else
#define CLASS_DECL_ACME_WINDOWING_UIKIT CLASS_DECL_IMPORT
#endif
