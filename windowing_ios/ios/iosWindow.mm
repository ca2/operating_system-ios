...
//   bounds.origin.y = 0;
//
//	iosImpact * frameView = [[iosImpact alloc] initWithFrame : bounds] ;
//   
...
////         self->m_bForOpeningMedia = false;
         ...
         [ picker start : self->m_pimpactcontroller ];
...
//{
//   m_pnsacmeimpact = [ [ iosImpact alloc ] initWithFrame: bounds andWindow: m_pacmewindowbridge ];
//}
...
-(void)create_impact_controller
{
   ...
   m_pimpactcontroller = [[iosImpactController alloc] init];
...
-(void)setBridge:(::uikit::acme_window_bridge *)pbridge
{
   ...
   m_pwindow = m_pacmewindowbridge->_ios_window();
