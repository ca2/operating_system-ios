...
# ifdef __i386__
#  ifdef __GNUC__
#   ifdef __APPLE__ /* Mac OS X uses a 16-unsigned char aligned stack and not a 4-unsigned char one */
...
#  ifdef __APPLE__ /* Mac OS X uses 16-unsigned char aligned stack and not a 4-unsigned char one */
