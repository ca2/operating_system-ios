...
#include "dialog.h"
#include "icon.h"
//#include "windowing_uikit/windowing.h"
//#include <QPushButton>
...
//             });
   ...
   void button::_create_child(window * pwindowParent)
   {
      ...
      //::pointer < ::innate_ui_uikit::impact > puikitwindowParent = pwindowParent;

      
      __create_button();
      //m_pqwidget = new QPushButton(puikitwindowParent->m_pqwidget);
