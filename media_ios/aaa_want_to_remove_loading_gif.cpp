...
namespace coreimage_imaging
{
   ...
   //bool draw2d_gif_load_frame(::image * pimageCompose, image_frame_array * pframea, image_frame * pointer, ::collection::collection::index uFrameIndex, u8 * ba, int iScan, colorref_array & cra, int transparentIndex);
      ...
      try
      {
         ...
         //if (true)
         {
            ...
            try
            {
               ...
               ::collection::collection::count cFrame = FreeImage_GetPageCount(m);
