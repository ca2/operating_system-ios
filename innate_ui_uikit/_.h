...
#if defined(_innate_ui_uikit_project)
#define CLASS_DECL_INNATE_UI_APPKIT  CLASS_DECL_EXPORT
#else
#define CLASS_DECL_INNATE_UI_APPKIT  CLASS_DECL_IMPORT
#endif
...
//
//
//CLASS_DECL_ACME_WINDOWS string read_resource_as_string(hinstance hinst, ::u32 nID, const char * pcszType, character_count iReadAtMostByteCount = -1);
