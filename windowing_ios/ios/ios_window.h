...
#pragma once
#include "acme_windowing_uikit/acme_window_bridge.h"
//#ifdef __OBJC__
...
//#endif
   ...
   virtual void ios_window_draw(CGContextRef cgc, CGSize sizeWindow, CGRect cgrect, int iYFlipHeight, double dSizeScaler) = 0;
   ...
   virtual void ios_window_moved(CGPoint i32_point) = 0;
   ...
   ios_window * _ios_window() override;
   
   
};

#ifdef __OBJC__
//UIWindow * new_ios_window(ios_window * pwindow, CGRect i32_rectangle, ::u32 uStyle);
#endif
