...
//      m_pqwidget = new QDialog();
      ...
      UIView * pview = (UIView *) button;
      
      m_pUIView = (__bridge_retained void *) pview;
...
//      }
   ...
   void button::__set_text(const char *pszText)
   {
      ...
      UIButton * pbutton = (UIButton *) (__bridge  UIView *) m_pUIView;
      
      [ pbutton setTitle : pstr forState: UIControlStateNormal];
   ...
   void button::__set_callback()
   {
      ...
      [pbutton addTarget: m_pcaller action:@selector(callProcedure)
