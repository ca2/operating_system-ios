...
namespace ios
{
   ...
   ::collection::count ip_enum::enumerate(string_array & stra)
   {
      ...
      if (gethostname(szHostname, sizeof(szHostname)))
      {
         ...
         information("Failed in call to gethostname, errno returns %d", errno);
      ...
      if (phostent == nullptr)
      {
         ...
         information("Failed in call to gethostbyname, errno returns %d", errno);
